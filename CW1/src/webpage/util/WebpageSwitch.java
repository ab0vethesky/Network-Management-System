...
public class WebpageSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case WebpagePackage.RESOURCE: {
				Resource resource = (Resource)theEObject;
				T result = caseResource(resource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WebpagePackage.SERVERS: {
				Servers servers = (Servers)theEObject;
				T result = caseServers(servers);
				if (result == null) result = caseResource(servers);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WebpagePackage.PRINTER: {
				Printer printer = (Printer)theEObject;
				T result = casePrinter(printer);
				if (result == null) result = caseResource(printer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WebpagePackage.COMPUTERS: {
				Computers computers = (Computers)theEObject;
				T result = caseComputers(computers);
				if (result == null) result = caseResource(computers);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WebpagePackage.JOB_QUEUE: {
				JobQueue jobQueue = (JobQueue)theEObject;
				T result = caseJobQueue(jobQueue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WebpagePackage.USERS: {
				Users users = (Users)theEObject;
				T result = caseUsers(users);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WebpagePackage.USER: {
				User user = (User)theEObject;
				T result = caseUser(user);
				if (result == null) result = caseUsers(user);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WebpagePackage.ADMINISTRATOR: {
				Administrator administrator = (Administrator)theEObject;
				T result = caseAdministrator(administrator);
				if (result == null) result = caseUsers(administrator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Computers</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Computers</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseComputers(Computers object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseJobQueue(JobQueue object) {
		return null;
	}
