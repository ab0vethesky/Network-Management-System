...
/**
 * This is the item provider adapter for a {@link webpage.User} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UserItemProvider extends UsersItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addUsidPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Usid feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addUsidPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_User_usid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_User_usid_feature", "_UI_User_type"),
				 WebpagePackage.Literals.USER__USID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebpagePackage.Literals.USER__UNAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((User)object).getUname();
